...
class ReserveController {
  async index(req, res) {
    ...
    const listUserReserves = new ListUserReservesUseCase(reserveRepository);
  ...
  async store(req, res) {
    ...
    const reserveRepository = new ReserveRepository(Reserve);
    const createReserve = new CreateReserveUseCase(houseRepository, reserveRepository);
  ...
  async update(req, res) {
    ...
    const reserveRepository = new ReserveRepository(Reserve);
    const updateReserve = new UpdateReserveUseCase(reserveRepository);
  ...
  async destroy(req, res) {
    ...
    const reserveRepository = new ReserveRepository(Reserve);
    const deleteReserve = new DeleteReserveUseCase(reserveRepository);
